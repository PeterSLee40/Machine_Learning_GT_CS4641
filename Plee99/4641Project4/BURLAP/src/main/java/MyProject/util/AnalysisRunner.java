...
public class AnalysisRunner {
	...
	public void runValueIteration(EasyGridWorld gen, Domain domain,
...
//		new EpisodeSequenceVisualizer(v, domain, Arrays.asList(ea));
	...
	public void runPolicyIteration(EasyGridWorld gen, Domain domain,
			State initialState, RewardFunction rf, TerminalFunction tf, boolean showPolicyMap) {
...
//		new EpisodeSequenceVisualizer(v, domain, Arrays.asList(ea));
	...
	public void runQLearning(EasyGridWorld gen, Domain domain,
