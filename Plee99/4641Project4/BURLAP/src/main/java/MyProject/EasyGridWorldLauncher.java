package MyProject;
//author: https://github.com/ckabuloglu/CS4641_HW4_MDPs_and_Reinforcement_Learning
import MyProject.util.AnalysisAggregator;
import MyProject.util.AnalysisRunner;
import MyProject.util.BasicRewardFunction;
import MyProject.util.BasicTerminalFunction;
...
//	private static Integer mapLen = map.length-1;
	...
	public static void main(String[] args) {
		...
		EasyGridWorld gen = new EasyGridWorld(map,maxX,maxY); //0 index map is 11X11
