...
public class geneticBreasts {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            OptimizationAlgorithm oa = new StandardGeneticAlgorithm(N,Mate,Mutate, nno);
            //GenericGeneticAlgorithmProblem a =GenericGeneticAlgorithmProblem(nno);
